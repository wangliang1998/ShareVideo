...
<div id="iframeId" style="background: white">
  <div class="panel-head" style="background: white;font-size: medium;margin-left: 15px;"><strong>个人评论信息维护</strong></div>
      <el-table
          :data="tableData"
          stripe
          border
...
export default {
  ...
  methods: {
    ...
    flush () {
      const _this = this
      this.startloading()
      axios.get(axios.defaults.baseURL + '/usr/comment/all',{
        params:{
